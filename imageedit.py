...
root = Tk()
root.title("07AJAYEMPIRE IMAGE EDITOR")
...
blurr = Label(root, text="Blur:", font=("atami 17 bold"), width=9, anchor='e')
blurr.place(x=15, y=8)
v1 = IntVar()
scale1 = ttk.Scale(root, from_=0, to=20, variable=v1, orient=HORIZONTAL, command=blur) 
scale1.place(x=150, y=10)
bright = Label(root, text="Brightness:", font=("atami 17 bold"))
bright.place(x=8, y=50)
v2 = IntVar()   
scale2 = ttk.Scale(root, from_=0, to=20, variable=v2, orient=HORIZONTAL, command=brightness) 
scale2.place(x=150, y=55)
contrast = Label(root, text="Contrast:", font=("atami 17 bold"))
contrast.place(x=35, y=92)
v3 = IntVar()   
scale3 = ttk.Scale(root, from_=0, to=20, variable=v3, orient=HORIZONTAL, command=contrast) 
scale3.place(x=150, y=100)
rotate = Label(root, text="Rotate:", font=("atami 17 bold"))
rotate.place(x=370, y=8)
values = [0, 90, 180, 270, 360]
rotate_combo = ttk.Combobox(root, values=values, font=("atami 10 "))
rotate_combo.place(x=460, y=15)
rotate_combo.bind("<<ComboboxSelected>>", rotate_image)
flip = Label(root, text="Flip:", font=("atami 17 bold"))
flip.place(x=400, y=50)
values1 = ["FLIP LEFT TO RIGHT", "FLIP TOP TO BOTTOM"]
flip_combo = ttk.Combobox(root, values=values1, font=("atami 10 "))
flip_combo.place(x=460, y=57)
flip_combo.bind("<<ComboboxSelected>>", flip_image)
border = Label(root, text="Add border:", font=("atami 17 bold"))
border.place(x=320, y=92)
values2 = [i for i in range(10, 45, 5)]
border_combo = ttk.Combobox(root, values=values2, font=("atami 10 "))
...
# create buttons
btn1 = Button(root, text="Browse", width=12, bg='red', fg='white', font=('ariel 15 bold'), relief=GROOVE, command=selected)
btn1.place(x=100, y=595)
btn2 = Button(root, text="Save", width=12, bg='red', fg='white', font=('ariel 15 bold'), relief=GROOVE, command=save)
btn2.place(x=280, y=595)
btn3 = Button(root, text="Exit", width=12, bg='red', fg='white', font=('ariel 15 bold'), relief=GROOVE, command=root.destroy)
